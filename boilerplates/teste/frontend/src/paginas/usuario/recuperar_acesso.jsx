...
import ModalRecuperarAcesso from "../../componentes/modais/modal_recuperar_acesso";
    ...
    <div className={estilizarFlex("center")}>
      ...
      <Card title="Recuperar Acesso de Usuario" className={estilizarCard()}>
        <p className={estilizarParagrafo()}>
          {`Para recuperar o acesso a sua conta, forneca as informacoes abaixo:`}
        </p>
        <div className={estilizarDivCampo()}>
          ...
          <InputMask
            ...
            autoClear
            value={dados.cpf}
            onChange={buscarQuestaoSeguranca}
          />
        </div>
        <div className={estilizarDivCampo()}>
          ...
          <InputText
            name="questao"
            className={estilizarInputText(erros.questao, 400)}
            value={dados.questao}
            disabled
          />
        </div>
